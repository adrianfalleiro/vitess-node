...
// @generated from protobuf file "vtrpc.proto" (package "vtrpc", syntax proto3)
// tslint:disable
//
//
 ...
 *
 * @generated from protobuf message vtrpc.CallerID
 */
export interface CallerID {
     ...
     *
     * @generated from protobuf field: string subcomponent = 3;
     */
    subcomponent: string;
    /**
 ...
 *
 * @generated from protobuf message vtrpc.RPCError
 */
export interface RPCError {
    ...
    message: string;
    /**
     * @generated from protobuf field: vtrpc.Code code = 3;
     */
    code: Code;
}
/**
 ...
 * 17+ are custom codes
 *
 * @generated from protobuf enum vtrpc.Code
 */
export enum Code {
    /**
     ...
     *
     * @generated from protobuf enum value: CLUSTER_EVENT = 17;
     */
    CLUSTER_EVENT = 17,
    /**
     * Topo server connection is read-only
     *
     * @generated from protobuf enum value: READ_ONLY = 18;
     */
    READ_ONLY = 18
}
// @generated message type with reflection information, may provide speed optimized methods
class CallerID$Type extends MessageType<CallerID> {
    constructor() {
        super("vtrpc.CallerID", [
    ...
    create(value?: PartialMessage<CallerID>): CallerID {
        ...
        message.groups = [];
        if (value !== undefined)
            reflectionMergePartial<CallerID>(this, message, value);
        return message;
    }
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: CallerID): CallerID {
    ...
    internalBinaryWrite(message: CallerID, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* string principal = 1; */
        ...
        if (message.subcomponent !== "")
            writer.tag(3, WireType.LengthDelimited).string(message.subcomponent);
...
/**
 * @generated MessageType for protobuf message vtrpc.CallerID
 */
export const CallerID = new CallerID$Type();
// @generated message type with reflection information, may provide speed optimized methods
class RPCError$Type extends MessageType<RPCError> {
    constructor() {
        super("vtrpc.RPCError", [
            { no: 2, name: "message", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
            { no: 3, name: "code", kind: "enum", T: () => ["vtrpc.Code", Code] }
        ]);
    }
...
/**
 * @generated MessageType for protobuf message vtrpc.RPCError
 */
